...
//			motions.push(animation.fromMotion3Json(resources['motion9'].data));
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/Chibinakko/chibinakko.model3.json", xhrType);
			loader.add('motion1', "assets/Chibinakko/hey.motion3.json", xhrType);
			loader.add('motion2', "assets/Chibinakko/idle.motion3.json", xhrType);
			loader.add('motion3', "assets/Chibinakko/idle2.motion3.json", xhrType);
			loader.add('motion4', "assets/Chibinakko/idle3.motion3.json", xhrType);
...
*/		return Promise.all([p1/*, p2*/]);
	...
	function addPlane() {
		...
		//マーカーを基準にしたモデルの相対位置
		plane.setAttribute('position', '1.4 0 0');
