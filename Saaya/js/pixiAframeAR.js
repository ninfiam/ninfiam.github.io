...
//			motions.push(animation.fromMotion3Json(resources['motion9'].data));
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/Saaya/saaya.model3.json", xhrType);
			loader.add('motion1', "assets/Saaya/motion1.motion3.json", xhrType);
			loader.add('motion2', "assets/Saaya/idle.motion3.json", xhrType);
			loader.add('motion3', "assets/Saaya/motion2.motion3.json", xhrType);
...
*/		return Promise.all([p1/*, p2*/]);
	...
	function addPlane() {
		...
		//マーカーを基準にしたモデルの相対位置
		plane.setAttribute('position', '1.4 0 -0.5');
		var stand = stand_mode ? '0 0 0' : '-15 0 0';
