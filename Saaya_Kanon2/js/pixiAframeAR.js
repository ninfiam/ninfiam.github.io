...
//			motions.push(animation.fromMotion3Json(resources['motion9'].data));
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/Saaya_Kanon/saayakanon.model3.json", xhrType);
			loader.add('motion1', "assets/Saaya_Kanon/touch.motion3.json", xhrType);
			loader.add('motion2', "assets/Saaya_Kanon/idle.motion3.json", xhrType);
...
*/		return Promise.all([p1/*, p2*/]);
	...
	function addPlane() {
		...
		//マーカーを基準にしたモデルの相対位置
		plane.setAttribute('position', '0.75 0 -0.5');
