...
//			motions.push(animation.fromMotion3Json(resources['motion9'].data));
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/Yaenako_v1/Yaenako_v1.model3.json", xhrType);
			loader.add('motion1', "assets/Yaenako_v1/touch.motion3.json", xhrType);
			loader.add('motion2', "assets/Yaenako_v1/idle.motion3.json", xhrType);
...
*/		return Promise.all([p1/*, p2*/]);
	...
	function addPlane() {
		...
		plane.setAttribute('height', '9');
		plane.setAttribute('width', '9');
		//マーカーを基準にしたモデルの相対位置
		plane.setAttribute('position', '1 3 0');
